...
<x-filament-panels::layout.base :livewire="$livewire">
    ...
    <div class="fi-simple-layout flex min-h-screen flex-col items-center">
        ...
        >
            ...
            >
            <div class="flex flex-1 justify-between mb-10 bg-gray-100 dark:bg-gray-800 p-5 rounded-md">
                <img src="{{ asset('assets/images/logo.png') }}" alt="" class="h-10 md:max-h-16">
                <img src="{{ asset('assets/images/gupin.png') }}" alt="" class="h-10 md:max-h-16">
            </div>
                {{ $slot }}
            </main>
        </div>
